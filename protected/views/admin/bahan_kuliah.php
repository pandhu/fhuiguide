<?php if(Yii::app()->session['success']):?>
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Bahan Kuliah</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
						...
						<table class="table table-striped table-bordered table-hover" id="dataTables-rancangan">
							...
							?>
								<tr>
									...
									<td>
										<button class="btn btn-warning btn-small btn-delete" data-title="<?php echo $item->judul?>" data-link="<?php echo Yii::app()->baseUrl?>/admin/deletebahankuliah/<?php echo $item->id?>">
											<i class="fa fa-times-circle"></i> Hapus
										</button>
										<a href="<?php echo Yii::app()->baseUrl.'/uploads/banksoal/'.$item->url.'.'.$item->filetype?>" target="_blank" class="btn btn-primary btn-small">
		...
		<div class="col-lg-12">
			<div class="panel panel-green">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-lg-12">
							<?php $form = $this->beginWidget('CActiveForm', array('id'=>'login-form', 'action'=>Yii::app()->baseUrl.'/admin/savebahankuliah/'.$matkul->id, 'htmlOptions'=>array('class'=>'col-md-6', 'enctype'=>'multipart/form-data')));?>
