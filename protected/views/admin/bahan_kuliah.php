...
foreach ($konten as $item): ?>
	<tr>
		...
		<td><a class="btn btn-danger btn-delete" data-title="<?php echo $item->judul?>" data-link="<?php echo Yii::app()->baseUrl;?>/admin/deletebahankuliah/<?php echo $item->id?>">Delete</a></td>
