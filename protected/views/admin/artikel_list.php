...
<?php
	...
	<tr>
		...
		<td>
			<a class="btn btn-default" data-title="<?php echo $data->judul?>" href="<?php echo Yii::app()->baseUrl;?>/artikel/post/<?php echo $data->url?>">View</a>
		</td> 	
		<td>
			<a class="btn btn-denger btn-delete" data-title="<?php echo $data->judul?>" data-link="<?php echo Yii::app()->baseUrl;?>/admin/deletepost/<?php echo $data->id?>">Delete</a>
		</td> 
		</div>
	</tr>
<?php
